...
<body>
    <div class="main-container">
        ...
        <div class="easyui-panel" title="Gerenciamento de Clientes" style="padding:10px;">
            <div style="margin-bottom:10px;">
                <a onclick="abrirDialogInclusao()" class="easyui-linkbutton" data-options="iconCls:'icon-add'">Incluir Cliente</a>
    ...
    <div id="dlg-buttons">
        <a class="easyui-linkbutton" iconCls="icon-ok" onclick="salvarCliente()" style="width:90px">Salvar</a>
...
<script>
    ...
    function formatActionCliente(value, row) {
        var btnModificar = '<a class="easyui-linkbutton" data-options="iconCls:\'icon-edit\',plain:true" onclick="abrirDialogModificacao(' + row.cod_cliente + ')">Modificar</a>'
        var btnExcluir = '<a class="easyui-linkbutton" data-options="iconCls:\'icon-remove\',plain:true" onclick="excluirCliente(' + row.cod_cliente + ')">Excluir</a>'
